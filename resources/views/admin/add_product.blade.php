                        ...
                        <div class="panel-body">
                            <div class="position-center ">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="3" type="text" class="form-control" name="product_decs" id="exampleInputPassword1" placeholder="Mô tả sản phẩm"></textarea>
                                </div>    
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nội dung sản phẩm</label>
                                    <textarea style="resize: none" rows="3" type="text" class="form-control" name="product_content" id="exampleInputPassword1" placeholder="Nội dung sản phẩm"></textarea>
                                </div>
                                <div class="form-group">
